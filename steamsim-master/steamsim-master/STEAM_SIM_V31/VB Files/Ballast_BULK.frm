...
Begin VB.Form Ballast_BULK 
   ...
   Begin Stretch_Control.HavenStretch HavenStretch1 
      ...
      Begin VB.OLE OLE1 
         ...
         Height          =   5025
         Left            =   4320
         OleObjectBlob   =   "Ballast_BULK.frx":4420
         SizeMode        =   1  'Stretch
   ...
   End
End
Attribute VB_Name = "Ballast_BULK"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private set_dummy_focus As Integer
Private skip_valve(40) As Boolean
'
...
If Index = 0 Then
   ...
   Call setPCDI(PumpIO_LSS(4, 27))      ' Ballast pump # 1

ElseIf Index = 1 Then

  ' === 06/03/03 ===
  'Call setPCDI(PumpIO_LSS(4, 40))      ' Ballast pump # 2
  'Call setPCDI(PumpIO_LSS(4, 42))      ' Ballast pump # 2
   Call setPCDI(3030)                   ' Ballast pump # 2
...
If Index = 0 Then
   ...
   Call setPCDI(PumpIO_LSS(2, 27))      ' Ballast pump # 1
   
ElseIf Index = 1 Then

  ' === 06/03/03 ===
  'Call setPCDI(PumpIO_LSS(2, 40))      ' Ballast pump # 2
  'Call setPCDI(PumpIO_LSS(2, 42))      ' Ballast pump # 2
   Call setPCDI(3031)                   ' Ballast pump # 2
...
Dim ZWP(1 To 4) As Single
Dim ZWS(1 To 4) As Single
...
For i = 1 To 4
    ...
    ZWP(i) = LSS_reals(842 + i)
    ZWS(i) = LSS_reals(846 + i)
...
'          === 31/05/02 Ballast pump # 1
'           PC_REALS(851) = P_ballast(37)
'          === 31/05/02 Ballast pump # 2
'           PC_REALS(852) = P_ballast(38)

    List1.clear
    List1.AddItem "Pump # 1   " & Format(LSS_reals(851), "##0.0")
    List1.AddItem "Pump # 2   " & Format(LSS_reals(852), "##0.0")
...
' === 31/05/02 ===
Call update_pump_LSS(Me, 0, 27)     ' Ballast pump # 1

  ' === 06/03/03 ===
'Call update_pump_LSS(Me, 1, 40)     ' Ballast pump # 2
Call update_pump_LSS(Me, 1, 42)     ' Ballast pump # 2



For i = 1 To 29
    If Not skip_valve(i) Then
        Call update_vvalve_LSS(Me, 300 + i, i, -1)
    End If
Next i

For i = 30 To 34
    If Not skip_valve(i) Then
        Call update_vvalve_LSS(Me, 333 + i, i, -1)
    End If
Next i
...
If Not skip_valve(Index) Then

       ' Open_ballast_valve(Index) = Not Open_ballast_valve(Index)
    If Index < 30 Then
        Call valve_pcdi_LSS(Index + 300)
    Else
        Call valve_pcdi_LSS(Index + 333)
    End If
