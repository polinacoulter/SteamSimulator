...
Begin VB.Form Controller_Drum_level_STBD 
   Caption         =   "Drum Level Controller STBD"
   ClientHeight    =   4530
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   3540
   ...
   End
End
Attribute VB_Name = "Controller_Drum_level_STBD"
...
' 28/11/99  MAN = 1 , SP = 3
'If VB_steam_integers(33) = 1 Then
If (VB_steam_integers(33) = 1 Or VB_steam_integers(33) = 3) Then
...
'If VB_steam_integers(33) = 2 Then
If (VB_steam_integers(33) = 2 Or VB_steam_integers(33) = 4) Then
...
Call JYAScreenInit(Me, id_drum_stbd)
...
If Not (Me.WindowState = 2 And frm_Host.WindowState = 1) Then
    ...
    Call JYAScreenResize(Me, id_drum_stbd)
...
If VB_steam_integers(33) = 1 Then
   ...
   ' MANUAL
    ...
    '
    '      Call setCONTROLLERvars(3, EdgeGaugectl1.Value)     'SP_man_drum(1)
    '
    ...
    '       Call setCONTROLLERvars(3, EdgeGaugectl1.Value)     'SP_man_drum(1)
    'Else
    '      EdgeGaugectl1.Value = Format(LSS_reals(270), "##0")   ' LEFT Gauge
    'End If

     
ElseIf VB_steam_integers(33) = 2 Then
   ...
   ' AUTO
    ...
    '      EdgeGaugectl1.Value = EdgeGaugectl1.Value + 1
    '
    '       Call setCONTROLLERvars(1, EdgeGaugectl1.Value)   ' SP_auto_drum(1)
    '
...
ElseIf VB_steam_integers(33) = 3 Then
...
ElseIf VB_steam_integers(33) = 4 Then
...
Call set_controller(33, 3, 1, 517, 515, 270)
...
'          PC_REALS(270) = dials(28)
'          PC_REALS(271) = dials(29)



'   Measured Value on the RIGHT HAND GAUGE
          EdgeGaugectl2.Value = LSS_reals(271)   ' RIGHT Gauge
