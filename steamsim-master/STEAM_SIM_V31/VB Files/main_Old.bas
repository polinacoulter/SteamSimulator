...
' NOW inluded with get_reals
'Declare Sub get_elec_reals Lib "c:\HAVEN\Model.DLL" (elec_reals As Single)
...
' 25/6/98    Debug.Print " Set_PCDI (Med Speed) " & nPCDI

   Else
    Call set_PCDI_LSS(nPCDI)                    '  SEND  to the "local"  LSS_SIM.DLL
    
' 25/6/98   Debug.Print " Set_PCDI_LSS " & nPCDI
...
Errhandler:
resp = MsgBox("The file E_SteamAlarmText.txt is missing or corrupted", vbOKOnly, "File Error")
