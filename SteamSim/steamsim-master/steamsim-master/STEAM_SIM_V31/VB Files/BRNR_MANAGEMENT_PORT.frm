...
Begin VB.Form BRNR_MANAGEMENT_PORT 
   Caption         =   "BURNER MANAGEMENT PORT"
   ClientHeight    =   9060
   ClientLeft      =   60
   ClientTop       =   300
   ClientWidth     =   12810
   ...
   End
End
Attribute VB_Name = "BRNR_MANAGEMENT_PORT"
...
' Method used up to NOV 1999 ( Opens the BOTV IMMEDIATELY but this is WRONG)
...
'    status_flag = True
'End If
'Call set_STEAM_logicals(77, status_flag)
...
'    status_flag = True
'End If
'Call set_STEAM_logicals(79, status_flag)
...
' OPEN the "FORV" valve
status_flag = True
Call setDI(DI_ON_VVIO_LSS(208), status_flag)
...
Private Sub EdgeGaugectl1_GotFocus()
...
If Index = 1 Then
    ' OPEN the "FORV" valve
    Call setPCDI(DI_ON_VVIO_LSS(208))
    ' OPEN the "MOTV" valve
    Call setPCDI(DI_ON_VVIO_LSS(216))
Else

    ' CLOSE the "FORV" valve
    Call setPCDI(DI_OFF_VVIO_LSS(208))
    ...
    If close_the_MOTV Then
        ...
        Call setPCDI(DI_OFF_VVIO_LSS(216))
    End If
...
Call JYAScreenInit(Me, id_BRNR_MANAGEMENT_PORT)
...
'EdgeGaugectl1.MinorTicks = 2
'Edge_gauge_string(0) = "0"
'Edge_gauge_string(1) = "5"
'Edge_gauge_string(2) = "10"
'Edge_gauge_string(3) = "15"
'Edge_gauge_string(4) = "20"
'Edge_gauge_string(5) = "25"
'EdgeGaugectl1.GaugeText Edge_gauge_string  ' Re-size smudge at present

'EdgeGaugectl1.GaugeScaleText = "Bar"
...
If Not (Me.WindowState = 2 And frm_Host.WindowState = 1) Then
    ...
    Call JYAScreenResize(Me, id_BRNR_MANAGEMENT_PORT)
...
' 4/9/00
If VB_steam_logicals(131) Then
  Scanner_gauge1(0).Value = LSS_reals(123) * 25.5
  Scanner_gauge1(1).Value = LSS_reals(124) * 25.5

  Scanner_gauge2(0).Value = LSS_reals(125) * 25.5
  Scanner_gauge2(1).Value = LSS_reals(126) * 25.5
Else
...
If LSS_reals(138) > 25# Then
  O2_val = 255
ElseIf LSS_reals(138) < 0# Then
  O2_val = 0
Else
  O2_val = LSS_reals(138) * 4# * 2.55
End If
O2_gauge.Value = O2_val
O2_lbl.Caption = Format(LSS_reals(138), "##0.0") & " %"

If LSS_reals(140) > 100# Then
  smoke_val = 255
ElseIf LSS_reals(140) < 0 Then
  smoke_val = 0
Else
  smoke_val = LSS_reals(140) * 2.55
End If
Smoke_gauge.Value = smoke_val
Smoke_lbl.Caption = Format(LSS_reals(140), "##0.0") & " %"
...
If VB_steam_logicals(131) Then
  For i = 0 To 6
    If VB_steam_logicals(52 + i) Then
...
' 4/9/00
If VB_steam_logicals(131) Then
  Call update_vvalve_LSS(Me, 216, 16, -1)
  If vv_status_LSS(216) = 0 Then
...
If VB_steam_logicals(131) Then
  For i = 0 To 4
    If VB_steam_logicals(66 + i) Then
...
If VB_steam_logicals(131) Then
  For i = 0 To 9
    If VB_steam_logicals(35 + i) Then
...
' FO Re-circ v/v
' 4/9/00
'Call find_VV_status_LSS(208)
'Call LABEL_control(FO_recirc_label(0), FO_recirc_label(1), "       CLOSED", "       OPEN", 208)
'
'Call Burner_LABEL_control(Burner1_label(0), Burner1_label(1), "       CLOSED", "       OPEN", 55, flash_burner_2_1)
'
'Call Burner_LABEL_control(Burner2_label(0), Burner2_label(1), "       CLOSED", "       OPEN", 58, flash_burner_2_2)
