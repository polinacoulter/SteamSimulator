...
Begin VB.Form Controller_Temp_STBD 
   Caption         =   "Steam Temperature STBD"
   ClientHeight    =   5355
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   3645
   ...
   End
End
Attribute VB_Name = "Controller_Temp_STBD"
...
' 28/11/99  MAN = 1 , SP = 3
'If VB_steam_integers(35) = 1 Then
If (VB_steam_integers(35) = 1 Or VB_steam_integers(35) = 3) Then
...
'If VB_steam_integers(35) = 2 Then
If (VB_steam_integers(35) = 2 Or VB_steam_integers(35) = 4) Then
...
Call JYAScreenInit(Me, id_temp_stbd)
...
If Not (Me.WindowState = 2 And frm_Host.WindowState = 1) Then
    ...
    Call JYAScreenResize(Me, id_temp_stbd)
...
If VB_steam_integers(35) = 1 Then
   ...
   '
   '       Call setCONTROLLERvars(13, EdgeGaugectl1.Value)     'SP_man_temp(1)
   '
   ...
   '        Call setCONTROLLERvars(13, EdgeGaugectl1.Value)     'SP_man_temp(1)
   ' Else
   '       EdgeGaugectl1.Value = Format(LSS_reals(274), "##0")   ' LEFT Gauge
   ' End If

     
ElseIf VB_steam_integers(35) = 2 Then
   ...
   '       EdgeGaugectl1.Value = EdgeGaugectl1.Value + 1
   '
   '        Call setCONTROLLERvars(11, EdgeGaugectl1.Value)   ' SP_auto_temp(1)
   '
...
ElseIf VB_steam_integers(35) = 3 Then
...
ElseIf VB_steam_integers(35) = 4 Then
...
If VB_steam_integers(35) = 1 Or VB_steam_integers(35) = 3 Then
    ...
    If INC_MAN_Mousedown Then
            ...
            Call setCONTROLLERvars(13, SP_manual)         'SP_man_temp(1)
    ElseIf DEC_MAN_Mousedown Then
            SP_manual = SP_manual - 1
            Call setCONTROLLERvars(13, SP_manual)         'SP_man_temp(1)
    Else
            SP_manual = LSS_reals(521)
    End If
...
If VB_steam_integers(35) = 2 Or VB_steam_integers(35) = 4 Then
     ...
     If INC_SP_Mousedown Then
            ...
            Call setCONTROLLERvars(11, SP_automatic)   ' SP_auto_temp(1)
    ElseIf DEC_SP_Mousedown Then
            SP_automatic = SP_automatic - 1
          Call setCONTROLLERvars(11, SP_automatic)    ' SP_auto_temp(1)
    Else
            SP_automatic = LSS_reals(519)
    End If
End If
          EdgeGaugectl1.Value = Format(LSS_reals(274), "##0")   ' LEFT Gauge
...
'   Measured Value on the RIGHT HAND GAUGE
          EdgeGaugectl2.Value = LSS_reals(275)   ' RIGHT Gauge
