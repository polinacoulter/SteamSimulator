...
Begin VB.Form Controller_Drum_level_PORT 
   Caption         =   "Drum Level Controller PORT"
   ClientHeight    =   4575
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   3420
   ...
   End
End
Attribute VB_Name = "Controller_Drum_level_PORT"
...
' 12/12/99
'c   === DRUM WATER LEVEL ( PID LOOPNUM 1 and 2 ) ===
'
'    equivalence(CONTROLLER_VARS(81),Td_drum(1))
'    equivalence(CONTROLLER_VARS(83),Ti_drum(1))
'    equivalence(CONTROLLER_VARS(85),PBand_drum(1))
'    equivalence(CONTROLLER_VARS(87),C_drum(1))
'
'    real*4              Td_drum(2),Ti_drum(2),PBand_drum(2),C_drum(2)
...
' 29/11/99  MAN = 1 , SP = 3
'If VB_steam_integers(34) = 1 Then
If (VB_steam_integers(34) = 1 Or VB_steam_integers(34) = 3) Then
...
' 29/11/99  AUTO = 2  , VLV = 4
'If VB_steam_integers(34) = 2 Then
If (VB_steam_integers(34) = 2 Or VB_steam_integers(34) = 4) Then
...
Call JYAScreenInit(Me, id_drum_port)
...
If Not (Me.WindowState = 2 And frm_Host.WindowState = 1) Then
    ...
    Call JYAScreenResize(Me, id_drum_port)
...
If VB_steam_integers(34) = 1 Then
   ...
   ' MANUAL
    ...
    '
    '      Call setCONTROLLERvars(4, EdgeGaugectl1.Value)     'SP_man_drum(2)
    '
    ...
    '       Call setCONTROLLERvars(4, EdgeGaugectl1.Value)     'SP_man_drum(2)
    'Else
    '      EdgeGaugectl1.Value = Format(LSS_reals(272), "##0")    ' LEFT Gauge
    'End If

     
ElseIf VB_steam_integers(34) = 2 Then
   ...
   '       EdgeGaugectl1.Value = EdgeGaugectl1.Value + 1
   '
   '        Call setCONTROLLERvars(2, EdgeGaugectl1.Value)    ' SP_auto_drum(2)
   '
...
ElseIf VB_steam_integers(34) = 3 Then
...
ElseIf VB_steam_integers(34) = 4 Then
...
' 29/11/99
Call set_controller(34, 4, 2, 518, 516, 272)


'        PC_REALS(515) = SP_auto_drum(1) * 255#
'        PC_REALS(516) = SP_auto_drum(2) * 255#
'        PC_REALS(517) = SP_man_drum(1) * 255#
'        PC_REALS(518) = SP_man_drum(2) * 255#


'          PC_REALS(272) = dials(76)
'          PC_REALS(273) = dials(77)



'   Measured Value on the RIGHT HAND GAUGE
          EdgeGaugectl2.Value = LSS_reals(273)     ' RIGHT Gauge
...
If VB_steam_integers(nINTEGERS) = 1 Or VB_steam_integers(nINTEGERS) = 3 Then
    ...
    If INC_MAN_Mousedown Then
            ...
            Call setCONTROLLERvars(c_man, SP_manual)
...
If VB_steam_integers(nINTEGERS) = 2 Or VB_steam_integers(nINTEGERS) = 4 Then
     ...
     If INC_SP_Mousedown Then
            ...
            Call setCONTROLLERvars(c_auto, SP_automatic)
