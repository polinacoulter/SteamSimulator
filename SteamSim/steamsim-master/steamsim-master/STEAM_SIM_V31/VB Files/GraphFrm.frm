...
' === 28/05/03 ===
Dim Update_Graph_flag As Boolean

Dim Label2_Captions(7) As String
...
File_List.Path = "c:\Steam_Sim\Plots" & "\" & Directory_Name
...
HavenStretch1.Width = Me.Width
HavenStretch1.Height = Me.Height
...
dirList.Path = "c:\Steam_Sim\Plots"
dirList.Refresh
...
Do While dirList.List(i) <> ""
    ...
    'Date_String = Mid$(Date_String, 16, Len(Date_String))
     Date_String = Mid$(Date_String, 20, Len(Date_String))
...
Date_String = dirList.List(0)
If Date_String <> "" Then
    File_List.Path = Date_String
Else
    File_List.Path = "c:\Steam_Sim\Plots"
End If
...
Date_label.Caption = Date_String
Directory_Name = Date_String
' ======================================
...
Open "c:\Steam_Sim\Plots\" & Directory_Name & "\" & File_name_C For Input As #77
...
For i = 0 To 7
    Input #77, Label2_Captions(i)
    Label2(i).Caption = Label2_Captions(i)
Next i
...
N_pens_used = 0
For i = 0 To 7
    If Label2(i).Caption = "Not Allocated" Or Label2(i).Caption = "Label2" Then
        ' We are NOT using this pen
    Else
       'N_pens_used = N_pens_used + 1
        N_pens_used = i + 1
    End If
Next i
...
Date_label.Caption = Directory_Name
...
Private Sub Timer1_Timer()
 ...
 ' GetData LatestData
   GetData New_data_real
   
' === 26/05/03 ===
For i = 1 To 8
    New_data(i) = New_data_real(i)
Next i
...
'======================
' === 28/05/03 To Solve "missing" date between multiple plots do this...===
'Call Update_the_graph
...
' === 28/05/03 To Solve "missing" date between multiple plots do this...===
'Call Update_the_graph
If Update_Graph_flag = True Then
...
Open "c:\Steam_Sim\Plots\" & Directory_Name & "\" & File_name_C For Output As #77
...
For i = 0 To 7
    'Label2_Captions(i) = Label2(i).Caption
    Write #77, Label2(i).Caption
Next i
...
Next i
    ...
    CmdSetup.Enabled = Not Plotter_Run_flag
...
MkDir "c:\Steam_Sim\Plots\" & Dir_name
