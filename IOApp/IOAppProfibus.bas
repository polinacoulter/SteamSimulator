...
Public Function Set_D_Output(Card As Integer, Start_addr As Integer, End_addr As Integer) As Boolean
    Dim Bit As Integer, TAIndex As Integer, base As Integer
    Dim Nb As Integer
    ...
    If Card = WINCARD_A Then skipList = CardA_DO_Skip Else skipList = CardB_DO_Skip

    Set_D_Output = False
    Nb = 4

    While Start_addr <= End_addr
        If Not IsBlockSkipped(skipList, Start_addr) Then
            TAIndex = 0
...
Public Function Set_A_Output(Card As Integer, Start_addr As Integer, End_addr As Integer) As Boolean
    ...
    If Card = WINCARD_A Then skipList = CardA_AO_Skip Else skipList = CardB_AO_Skip
...
Public Function Get_A_Input(Card As Integer, Start_addr As Integer, End_addr As Integer) As Boolean
    ...
    If Card = WINCARD_A Then skipList = CardA_AI_Skip Else skipList = CardB_AI_Skip
...
Public Function Get_D_input(Card As Integer, Start_addr As Integer, End_addr As Integer) As Boolean
    ...
    If Card = WINCARD_A Then skipList = CardA_DI_Skip Else skipList = CardB_DI_Skip
